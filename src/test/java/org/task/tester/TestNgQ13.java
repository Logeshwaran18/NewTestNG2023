...
public class TestNgQ13 extends Base {
	...
	private void tc2() {
		...
		fill(lastName, "waran");
		Assert.assertEquals(PrintAttribute(lastName, "value"), "waran","check the lastname");
	}
	@Test
	private void tc3() { 
		WebElement email = driver.findElement(By.id("userEmail"));
		fill(email, "logesh@gmail.com");
		Assert.assertEquals(PrintAttribute(email, "value"), "logeszzh@gmail.com","check the email");
	}
	@Test
	private void tc4() {
